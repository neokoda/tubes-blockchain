...
export const INVOICE_LENDING_ABI = [
  ...
  "function loans(uint256) view returns (uint256 id, address borrower, uint256 amountRequested, uint256 amountFunded, string ipfsHash, string invoiceNumber, uint256 interestRate, uint256 duration, uint256 startTime, uint8 state, address[] investors)",
  "function createLoanRequest(uint256 _amount, uint256 _interest, uint256 _duration, string _ipfsHash, string _invoiceNumber) external",
